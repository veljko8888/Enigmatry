...
using Vendor.Infrastructure.Core.Services;
...
namespace Vendor.Api
{
    public class Startup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IInventory, SupplierOneRepository>();
            services.AddSingleton<IInventory, SupplierTwoRepository>();
            services.AddScoped<IShopService, DealerService>();
            services.AddSingleton<IDb, VendorDb>();
